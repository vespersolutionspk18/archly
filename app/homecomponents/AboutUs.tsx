    ...
    <div className="w-full p-4 sm:p-6 md:p-8 lg:p-16 bg-white flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-10 items-center lg:items-start relative z-10">
       <div className="relative w-full sm:w-4/5 md:w-3/4 lg:w-1/3 h-[250px] sm:h-[300px] md:h-[400px] lg:h-[880px] rounded-lg lg:rounded-none overflow-hidden">
        <Image
          ...
          alt="Kitchen and bathroom remodel design"
          fill
       ...
       <h5 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-sans tracking-tighter leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-snug">
        Specialized in kitchen and bathroom remodels, room additions, and open concept conversions. Our permit-ready drawings get approved fast, while photorealistic 3D renderings help you sell projects before breaking ground.

<br className="hidden sm:block"></br><br className="hidden sm:block"></br>Every project includes FREE 4K walkthrough videos, contractor CRM, professional website, and AI design assistant. Average project values increase by $25,000 when you present with our professional visualization tools.
       </h5>
      <a className="font-mono text-base sm:text-lg md:text-xl hover:underline transition-all duration-300 text-center lg:text-left inline-block" href="/contact">GET STARTED TODAY</a>
       </div>
    </div>
  )
}
